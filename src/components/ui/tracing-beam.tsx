        ...
        >
          ...
          <defs>
            ...
            >
              ...
              <stop offset="0.325" stopColor="#ea580c"></stop>
              <stop offset="1" stopColor="#eab308" stopOpacity="0"></stop>
            </motion.linearGradient>
          </defs>
        </svg>
      </div>
      <motion.div ref={contentRef} className="ml-6 md:ml-20">
        {children}
      </motion.div>
    </motion.div>
  );
...
const TracingBeamItem: React.FC<{
  children: React.ReactNode;
  className?: string;
}> = ({ children, className }) => {
  return (
...
export { TracingBeam, TracingBeamItem };
